...
import Menu from './Menu.vue'; // your dropdown
...
<template>
  <div class="relative flex items-center bg-gray-900 text-white px-6 py-4 hover:bg-gray-800">
    <!-- Name & Region -->
    <div class="w-1/5">
    ...
    <div class="w-1/5 flex justify-end relative">
      ...
      <!-- Only rendered by AssetRow, never inside Menu.vue itself -->
